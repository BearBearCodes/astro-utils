...
def add_scalebar(
    ...
    **kwargs,
    ...
    """
    Adds a 1 kpc scale bar (by default) to a plot. This is basically Dr. Toby Brown's code
    (I just can't find his original snippet so I'm including this here for my own use).
...
def add_beam(ax, header, xy=(0, 0), **kwargs):
    ...
    from radial_profile.radial_profile_utils import get_beam_size_px
